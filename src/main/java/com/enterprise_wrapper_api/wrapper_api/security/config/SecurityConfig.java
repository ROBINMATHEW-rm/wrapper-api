    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.DELETE, "/rag/clear").hasAuthority("ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/rag/documents/**").hasAuthority("ROLE_ADMIN")

                // All other RAG endpoints require at least ROLE_USER
                .requestMatchers("/rag/**").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
